...
SITE_ID = 1
#Add corsheaders.middleware.CorsMiddleware to MIDDLEWARE(pay attention to it's position)
...
ACCOUNT_SIGNUP_FIELDS = {
    'username': {'required': True},  # Set to False if username is optional
    'email': {'required': True},  # Set to False if email is optional
}

# Disable email verification
ACCOUNT_EMAIL_VERIFICATION = 'none'  # Turns off mandatory emails
